# Marcs Portfolio Theme based on Nightfall

This theme is based on Nightfall, which itself is a minimal dark theme for Hugo. [Demo](https://hugo-theme-nightfall.netlify.app)
